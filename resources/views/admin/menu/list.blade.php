...
@section('content')
    ...
    <div class="row filters m-0">
        ...
        <div class="row m-0 col gradient-panel  p-3 align-items-center justify-content-center">
            <a class="btn btn-success ml-auto btn-sm" href="/admin/menu/create"><i class="fas fa-plus"></i> New</a>
        ...
        @endif
            <table>
                ...
                <tbody style="">
                    @foreach($datasets['menu']['rows'] as $row)
                        <tr >
                            ...
                            <td>
                            @foreach($row->menuItems()->get() as $perm)
                            ...
                            <td >
                                <a href="/admin/menu/update?menu={{$row->id}}" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                        ...
                        <div class="modal fade" id="{{str_replace(' ','_', $row->name)}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                            <div class="modal-dialog rounded-0" role="document">
                                ...
                                <div class="modal-header bg-danger rounded-0">
                                    <h5 class="modal-title text-white" id="exampleModalLongTitle">Delete Menu {{$row->name}}</h5>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a class="btn btn-danger" href="/admin/menu/delete?menu={{$row->id}}">Delete</a>
                                </div>
                                </div>
                            </div>
                        </div>
