...
@section('content')
    ...
    <div class="row filters m-0">
        ...
        <div class="row m-0 col gradient-panel  p-3 align-items-center justify-content-center">
            <a class="btn btn-success ml-auto btn-sm" href="/admin/sizes/create"><i class="fas fa-plus"></i> New</a>
                    ...
                    @foreach($datasets['reviews']['rows'] as $row)
                        ...
                        <tr >
                            ...
                            <td>
                             ...
                             <td >
                                @foreach($row->columns()->get() as $perm)
                                    <span class="badge rounded-0 badge-primary d-block mt-1">{{$perm->name}}</span>
                                @endforeach
                             </td>
                            ...
                            <td >
                                <a href="/admin/sizes/update?size={{$row->id}}" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                        ...
                        <div class="modal fade" id="{{str_replace(' ','_', $row->name)}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                            <div class="modal-dialog rounded-0" role="document">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a class="btn btn-danger" href="/admin/sizes/delete?size={{$row->id}}">Delete</a>
                                </div>
                                </div>
                            </div>
                        </div>
