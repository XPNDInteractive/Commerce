...
@section('content')
    ...
    <div class="row filters m-0">
        ...
        <div class="row m-0 col gradient-panel  p-3 align-items-center justify-content-center">
            <a class="btn btn-success ml-auto btn-sm" href="/admin/reviews/create"><i class="fas fa-plus"></i> New</a>
                ...
                <tbody style="">
                    @foreach($datasets['reviews']['rows'] as $row)
                        ...
                        <tr >
                            ...
                            <td >{{$row->title}}</td>
                            <td >{{$row->message}}</td>
                            <td ><div class="rating-inactive" data-rate-value={{$row->rating}} style="font-size: 1rem;"></div></td>
                           <td>
                                @foreach($row->products()->get() as $perm)
                            ...
                            <td >
                                <a href="/admin/reviews/update?review={{$row->id}}" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                        ...
                        <div class="modal fade" id="{{str_replace(' ','_', $row->name)}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                            <div class="modal-dialog rounded-0" role="document">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a class="btn btn-danger" href="/admin/reviews/delete?review={{$row->id}}">Delete</a>
                                </div>
                                </div>
                            </div>
                        </div>
