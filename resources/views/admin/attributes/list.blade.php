...
@section('content')
    ...
    <div class="row filters m-0">
        ...
        <div class="row m-0 col gradient-panel  p-3 align-items-center justify-content-center">
            <a class="btn btn-success ml-auto btn-sm" href="/admin/attributes/create"><i class="fas fa-plus"></i> New</a>
                ...
                <tbody style="">
                    @foreach($datasets['attributes']['rows'] as $row)
                        <tr >
                            ...
                            @foreach($row->values()->get() as $perm)
                                    <span class="badge rounded-0 badge-primary d-block mt-1">{{$perm->value}}</span>
                                @endforeach
                            </td>
                            ...
                            <td >
                                <a href="/admin/attributes/update?attribute={{$row->id}}" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                        ...
                        <div class="modal fade" id="{{str_replace(' ','_', $row->name)}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                            <div class="modal-dialog rounded-0" role="document">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a class="btn btn-danger" href="/admin/attributes/delete?attribute={{$row->id}}">Delete</a>
                                </div>
                                </div>
                            </div>
                        </div>
